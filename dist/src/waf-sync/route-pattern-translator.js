...
exports.toWafStatement = toWafStatement;
const constants_1 = require("./constants");
// ---------------------------------------------------------------------------
// Constants
// ---------------------------------------------------------------------------
/** Default text transformation applied to all match statements. */
const DEFAULT_TEXT_TRANSFORMATIONS = [
    { priority: 0, type: constants_1.WafTextTransformation.NONE },
];
// ---------------------------------------------------------------------------
// Public API
// ---------------------------------------------------------------------------
 ...
 *
 */
function toWafStatement(pattern) {
 ...
 */
function buildRegexStatement(pattern) {
    return {
 ...
 */
function buildExactlyStatement(searchString) {
    return {
        fieldToMatch: { uriPath: {} },
 ...
 */
function buildStartsWithStatement(searchString) {
    return {
        fieldToMatch: { uriPath: {} },
...
//# sourceMappingURL=route-pattern-translator.js.map